...
- [Homebrew](https://brew.sh/) - 软件管理，后面有很多软件都是用 Homebrew 安装
...
- Virtualbox - 虚拟机，`brew cask install virtualbox`
...
- [Eudic 欧路词典](https://apps.apple.com/cn/app/eudic-%E6%AC%A7%E8%B7%AF%E8%AF%8D%E5%85%B8/id434350458?mt=12) - Lite 版不支持第三方词库，基本够用
...
- [iStat Menu](https://bjango.com/mac/istatmenus/) - 菜单栏里的系统监控工具，收费
- [iGlance](https://github.com/iglance/iGlance) - 菜单栏里的系统监控工具，多了个风扇转速
...
- [BitBar](https://github.com/matryer/bitbar), [Plugins](https://github.com/matryer/bitbar-plugins)
...
- [KeePass](https://keepass.info/) - 密码管理
  ...
  - [KeepassXC](https://keepassxc.org/) - 跨平台 [Github](https://github.com/keepassxreboot/keepassxc/)
  - [KeeWeb](https://keeweb.info/) - Web 端和桌面端， [Github](https://github.com/keeweb/keeweb)
  - [MacPass](https://macpassapp.org) - Mac 客户端，[GitHub](https://github.com/MacPass/MacPass)
- LastPass - Google 插件
