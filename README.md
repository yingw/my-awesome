...
## 数据库
- [Amoeba](http://wiki.hexnova.com/display/amoeba/Home)  [:octocat:](https://sourceforge.net/projects/amoeba/files/) 支持数据分片的分布式关系型数据库 
...
- [Derby](https://db.apache.org/derby/)  [:octocat:](https://svn.apache.org/repos/asf/db/derby/code/branches/) Apache 的轻量级可嵌入应用服务器数据库 
...
- Kibana  [:octocat:](https://www.elastic.co/products/kibana) ELK 的前端展示中心 
- logstash  [:octocat:](https://www.elastic.co/products/logstash) Log 收集组件 
...
- [Apache HTTP Server](http://httpd.apache.org/)  [:octocat:](https://svn.apache.org/repos/asf/httpd/httpd/branches/) Apache 的 HTTP 服务器 
...
- JRebel  [:octocat:](https://zeroturnaround.com/software/jrebel/) 商用的 Eclipse Tomcat 热部署插件 
## Java
...
- JCaptcha  [:octocat:](http://jcaptcha.sourceforge.net/) Java 的验证码 
- Joda-Time [:octocat:](https://github.com/JodaOrg/joda-time) [:octocat:](http://www.joda.org/joda-time/) Java 的日期时间操作，Java8 后就建议用 java.time 
...
## JDBC
- C3P0  [:octocat:](https://sourceforge.net/projects/c3p0/)  
...
- ybg-plus  [:octocat:](https://gitee.com/SYDeament/ybg_plus) 云报告 ybg3.0极速版 :triangular_flag_on_post:
- ybg-spring-fast  [:octocat:](https://gitee.com/YYDeament/88ybg) 云报告 :triangular_flag_on_post:
## Tools
...
- Jira  [:octocat:](https://www.atlassian.com/software/jira) Atlassian 商用的问题跟踪系统 :heavy_dollar_sign:
- JSON    
- JSONView  [:octocat:](https://chrome.google.com/webstore/detail/jsonview/chklaanhfefbnpoihckbnefhakgolnmc) Chrome 插件 JSON 工具 
- JSONLint  [:octocat:](https://jsonlint.com/) 在线 JSON 工具 
- KindEditor  [:octocat:](http://kindeditor.net) 可视化 HTML 编辑器 
- Limesurvey  [:octocat:](https://www.limesurvey.org/) 开源的 PHP 调查问卷系统 
- Mantis  [:octocat:](http://www.mantisbt.org/) 问题跟踪系统 
- MingGW  [:octocat:](http://www.mingw.org/) Windows 上 Linux 命令模拟环境 
- ModSecurity  [:octocat:](http://www.modsecurity.org/) Web 应用防火墙 
- Netty  [:octocat:](http://netty.io/) NIO（非阻塞I/O）框架 
- OpenShift  [:octocat:](https://www.openshift.com/) RedHat 的 Kubernetes 和私有云平台 
- OpenProj  [:octocat:](https://sourceforge.net/projects/openproj/) 项目管理软件，代替Office Project，已终结 :warning:
